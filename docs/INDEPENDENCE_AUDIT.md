...
- Mole 检查范围：`open-cleaner/`、`scripts/`、`tests/`、`.github/`。
...
| --- | ---: | ---: | ---: | --- |
| `open-cleaner/SKILL.md` | 117 | 138 | 71 | frontmatter 标记、代码围栏、项目名称和通用标题。 |
| `open-cleaner/scripts/scan.py` | 320 | 428 | 287 | Python imports、`try`/`continue`、标准 main 入口和通用单位列表。 |
| `open-cleaner/scripts/build_report.py` | 55 | 65 | 40 | shebang、Usage 入口、标准 main 入口和 `os`/`sys` imports。 |
| `open-cleaner/scripts/server.py` | 250 | 273 | 221 | 标准库 imports、Usage 入口、KeyboardInterrupt 和 main 入口。 |
| `open-cleaner/assets/report_template.html` | 497 | 521 | 439 | HTML 标签、脚本/样式闭合标签、报告标题。 |
| `open-cleaner/references/macos.md` | 62 | 40 | 50 | 无完全相同的非空行。 |
| `open-cleaner/references/windows.md` | 33 | 37 | 24 | 仅“多盘符”通用标题。 |
